...
{
    internal class MetaObjectCommonRepositoryBase<TEntity> : CommonRepositoryBase<TEntity>, IMetaObjectCommonRepositoryBase<TEntity> where TEntity : MetaObjectCommonBase
    {
